...
.constant('XPATH', {
   ...
   getProseInterpretativeNodes: '//body//p//text()[not((ancestor::sic|ancestor::orig|ancestor::abbr|ancestor::am|ancestor::note))]',
   ...
   ns : {
     ...
     // getDiplomaticNodesBetween:'(.//(following::text()[normalize-space()]|following::ns:g) intersect .//following::ns:lb[1]//(preceding::text()[normalize-space()]|preceding::ns:g))[not((ancestor::ns:corr|ancestor::ns:reg|ancestor::ns:expan|ancestor::ns:ex|ancestor::ns:note))]',
      ...
      getProseInterpretativeNodes: '//ns:body//ns:p//text()[not((ancestor::ns:sic|ancestor::ns:orig|ancestor::ns:abbr|ancestor::ns:am|ancestor::ns:note))]',
