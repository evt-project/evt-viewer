 ...
 * @name evtviewer.depaReading.directive:evtDepaReading
 * @description 
 * # evtDepaReading
 ...
 * <p>The initial scope is expanded in {@link evtviewer.reading.evtDepaReading evtDepaReading} provider.</p>
 *
 * @scope
...
.directive('evtDepaReading', function(evtDepaReading, parsedData, evtInterface) {
    return {
        restrict: 'E',
        scope: {
            appId       : '@',
        ...
        transclude: true,
        templateUrl: 'src/depaReading/depaReading.directive.tmpl.html',
        controllerAs: 'vm',
        controller: 'DepaReadingCtrl',
        link: function(scope, element, attrs){
            ...
            var currentReading = evtDepaReading.build(scope.appId, scope);
