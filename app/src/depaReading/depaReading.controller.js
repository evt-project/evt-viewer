 ...
 * @name evtviewer.depaReading.controller:DepaDepaReadingCtrl
 * @description 
 * # DepaReadingCtrl
 * This is the controller for the {@link evtviewer.depaReading.directive:evtDepaReading evtDepaReading} directive. 
 * @requires $log
 * @requires $scope
 * @requires evtviewer.core.config
 * @requires evtviewer.reading.evtDepaReading
...
.controller('DepaReadingCtrl', function(config, $log, $scope, evtDepaReading, parsedData, evtPopover, evtCriticalApparatusParser, baseData, evtInterface, evtCriticalApparatusEntry, evtApparatuses, evtBox) {
    var vm = this;
    ...
    /**
     * @ngdoc method
     * @name evtviewer.reading.controller:DepaReadingCtrl#mouseOver
     * @methodOf evtviewer.reading.controller:DepaReadingCtrl
     *
     * @description
    ...
    /**
     * @ngdoc method
     * @name evtviewer.reading.controller:DepaReadingCtrl#mouseOut
     * @methodOf evtviewer.reading.controller:DepaReadingCtrl
     *
     * @description
    ...
    /**
     * @ngdoc method
     * @name evtviewer.reading.controller:DepaReadingCtrl#setSelected
     * @methodOf evtviewer.reading.controller:DepaReadingCtrl
     *
     * @description
    ...
    /**
     * @ngdoc method
     * @name evtviewer.reading.controller:DepaReadingCtrl#unselect
     * @methodOf evtviewer.reading.controller:DepaReadingCtrl
     *
     * @description
    ...
    /**
     * @ngdoc method
     * @name evtviewer.reading.controller:DepaReadingCtrl#isSelect
     * @methodOf evtviewer.reading.controller:DepaReadingCtrl
     *
     * @description
    ...
    /**
     * @ngdoc method
     * @name evtviewer.reading.controller:DepaReadingCtrl#isApparatusOpened
     * @methodOf evtviewer.reading.controller:DepaReadingCtrl
     *
     * @description
    ...
    /**
     * @ngdoc method
     * @name evtviewer.reading.controller:DepaReadingCtrl#closeApparatus
     * @methodOf evtviewer.reading.controller:DepaReadingCtrl
     *
     * @description
    ...
    /**
     * @ngdoc method
     * @name evtviewer.reading.controller:DepaReadingCtrl#openApparatus
     * @methodOf evtviewer.reading.controller:DepaReadingCtrl
     *
     * @description
    ...
    /**
     * @ngdoc method
     * @name evtviewer.reading.controller:DepaReadingCtrl#toggleOverAppEntries
     * @methodOf evtviewer.reading.controller:DepaReadingCtrl
     *
     * @description
    ...
    this.toggleOverAppEntries = function($event) {
        ...
        if ( !vm.hidden ) {
            if ( vm.over === false ) {
                evtDepaReading.mouseOverByAppId(vm.appId);
                evtCriticalApparatusEntry.mouseOverByAppId(vm.appId);
            } else {
                evtDepaReading.mouseOutAll();
    ...
    /**
     * @ngdoc method
     * @name evtviewer.reading.controller:DepaReadingCtrl#toggleSelectAppEntries
     * @methodOf evtviewer.reading.controller:DepaReadingCtrl
     *
     * @description
    ...
    this.toggleSelectAppEntries = function($event) {
        if ( !vm.hidden ) {
            if (vm.selected === false) {
                evtDepaReading.selectById(vm.appId);
    ...
    /**
     * @ngdoc method
     * @name evtviewer.reading.controller:DepaReadingCtrl#toggleApparatus
     * @methodOf evtviewer.reading.controller:DepaReadingCtrl
     *
     * @description
    ...
    this.toggleApparatus = function($event) {
        ...
        if ( !vm.hidden && vm.over ) {
            ...
            evtDepaReading.closeAllApparatus(vm.uid);
            vm.apparatus.opened = !vm.apparatus.opened;
        }
    };
    /**
     * @ngdoc method
     * @name evtviewer.reading.controller:DepaReadingCtrl#callbackClick
     * @methodOf evtviewer.reading.controller:DepaReadingCtrl
     *
     * @description
     ...
     * ({@link evtviewer.reading.controller:DepaReadingCtrl#toggleSelectAppEntries toggleSelectAppEntries()})</li>
     * <li>If the apparatus is in inline mode and is not yet opened, toggle the state of the 
     * connected critical apparatus entry ({@link evtviewer.reading.controller:DepaReadingCtrl#toggleApparatus toggleApparatus()})</li>
     * </ul>
     * @param {event} $event click event
     */
    ...
    /**
     * @ngdoc method
     * @name evtviewer.reading.controller:DepaReadingCtrl#openApparatusSubContent
     * @methodOf evtviewer.reading.controller:DepaReadingCtrl
     *
     * @description
    ...
    /**
     * @ngdoc method
     * @name evtviewer.reading.controller:DepaReadingCtrl#backgroundColor
     * @methodOf evtviewer.reading.controller:DepaReadingCtrl
     *
     * @description
    ...
    var colorFilters = function() {
        ...
        if (vm.parentAppId) {
            var parentRef = evtDepaReading.getById(vm.parentAppId);
    ...
    /**
     * @ngdoc method
     * @name evtviewer.reading.controller:DepaReadingCtrl#fitFilters
     * @methodOf evtviewer.reading.controller:DepaReadingCtrl
     *
     * @description
    ...
    /**
     * @ngdoc method
     * @name evtviewer.reading.controller:DepaReadingCtrl#destroy
     * @methodOf evtviewer.reading.controller:DepaReadingCtrl
     *
     * @description
     *  <p>Remove instance from saved instances in {@link evtviewer.reading.evtDepaReading evtDepaReading} provider.</p>
     */
    this.destroy = function() {
        var tempId = this.uid;
        // TODO: remove from list and collection
        // this.$destroy();
        evtDepaReading.destroy(tempId);
        // _console.log('vm - destroy ' + tempId);
    };
    // _console.log('DepaReadingCtrl running');
});