 ...
 * @name evtviewer.reading.evtDepaReading
 * @description 
 * # evtDepaReading
 * This provider expands the scope of the
 * {@link evtviewer.reading.directive:evtDepaReading evtDepaReading} directive 
...
.provider('evtDepaReading', function() {
    ...
    this.$get = function(config, parsedData) {
        ...
        /**
         * @ngdoc method
         * @name evtviewer.reading.evtDepaReading#build
         * @methodOf evtviewer.reading.evtDepaReading
         *
         * @description
         * <p>This method will extend the scope of {@link evtviewer.reading.directive:evtDepaReading evtDepaReading} directive 
        ...
        /**
         * @ngdoc method
         * @name evtviewer.reading.evtDepaReading#getById
         * @methodOf evtviewer.reading.evtDepaReading
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name evtviewer.reading.evtDepaReading#getList
         * @methodOf evtviewer.reading.evtDepaReading
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name evtviewer.reading.evtDepaReading#setCurrentAppEntry
         * @methodOf evtviewer.reading.evtDepaReading
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name evtviewer.reading.evtDepaReading#getCurrentAppEntry
         * @methodOf evtviewer.reading.evtDepaReading
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name evtviewer.reading.evtDepaReading#mouseOutAll
         * @methodOf evtviewer.reading.evtDepaReading
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name evtviewer.reading.evtDepaReading#mouseOverByAppId
         * @methodOf evtviewer.reading.evtDepaReading
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name evtviewer.reading.evtDepaReading#unselectAll
         * @methodOf evtviewer.reading.evtDepaReading
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name evtviewer.reading.evtDepaReading#closeAllApparatus
         * @methodOf evtviewer.reading.evtDepaReading
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @name evtviewer.reading.evtDepaReading#selectById
         * @methodOf evtviewer.reading.evtDepaReading
         *
         * @description
         ...
         * ({@link evtviewer.reading.evtDepaReading#setCurrentAppEntry setCurrentAppEntry()}).</p>
         * @param {string} appId id of critical apparatus entry to handle
         */
        ...
        /**
         * @ngdoc method
         * @name evtviewer.reading.evtDepaReading#destroy
         * @methodOf evtviewer.reading.evtDepaReading
         *
         * @description
