...
.service('parsedData', function($log) {
    ...
    var mockText2 = [{
        title: 'The Dream of the Rood',
        page: '104v',
        diplomatic: './data/output_data/diplomatic/page_VB_fol_104v_diplomatic.html',
        interpretative: './data/output_data/interpretative/page_VB_fol_104v_interpretative.html',
    }, {
        title: 'The Dream of the Rood',
        page: '105r',
        diplomatic: './data/output_data/diplomatic/page_VB_fol_105r_diplomatic.html',
        interpretative: './data/output_data/interpretative/page_VB_fol_105r_interpretative.html',
    }, {
        title: 'The Dream of the Rood',
        page: '105v',
        diplomatic: './data/output_data/diplomatic/page_VB_fol_105v_diplomatic.html',
        interpretative: './data/output_data/interpretative/page_VB_fol_105v_interpretative.html',
    },{
        title: 'The Dream of the Rood',
        page: '106r',
        diplomatic: './data/output_data/diplomatic/page_VB_fol_106r_diplomatic.html',
        interpretative: './data/output_data/interpretative/page_VB_fol_106r_interpretative.html',
    }];
