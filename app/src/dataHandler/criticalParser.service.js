...
.service('evtCriticalParser', ['$q', 'parsedData', 'evtParser', 'evtCriticalApparatusParser', 'evtCriticalElementsParser', 'config', 'evtDepaParser',
	function($q, parsedData, evtParser, evtCriticalApparatusParser, evtCriticalElementsParser, config, evtDepaParser) {
		var parser = {};
