...
.provider('evtNamedEntity', function() {
     ...
     **/
    this.$get = ['$timeout', 'config', 'parsedData', 'evtNamedEntitiesParser', 'evtInterface', 'evtNamedEntityRef', 'evtPinnedElements', 'evtDialog', 'evtList',
        function($timeout, config, parsedData, evtNamedEntitiesParser, evtInterface, evtNamedEntityRef, evtPinnedElements, evtDialog, evtList) {
            var namedEntity    = {},
                collection = {},
                list       = [],
                idx        = 0;
